  ...
  return (
    <div className="relative inline-block" ref={ref}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-lg bg-bg-surface border border-border-default text-text-secondary hover:bg-bg-elevated hover:border-border-strong hover:text-text-primary transition-all duration-200 text-sm font-medium"
      ...
      {open && (
        <div
          ...
          className="absolute right-0 mt-2 w-64 rounded-xl bg-bg-surface border border-border-default shadow-2xl z-50 overflow-hidden"
        >
          {/* Header */}
