...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-[var(--bg-deep)] text-white relative overflow-hidden font-sans selection:bg-cyan-500/30">
            {/* Dynamic Background */}
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-[-20%] right-[-10%] w-[800px] h-[800px] bg-purple-600/20 rounded-full blur-[120px] mix-blend-screen animate-pulse-slow" />
                <div className="absolute bottom-[-20%] left-[-10%] w-[600px] h-[600px] bg-cyan-600/10 rounded-full blur-[100px] mix-blend-screen" />
                <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 brightness-100 contrast-150"></div>
            </div>

            {/* Navigation */}
            <nav className="relative z-50 px-6 py-6 border-b border-white/5 bg-black/20 backdrop-blur-md">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gradient-to-tr from-cyan-400 to-blue-600 rounded-lg flex items-center justify-center shadow-[0_0_20px_rgba(56,189,248,0.3)]">
                            <Terminal className="text-white" size={20} />
                        </div>
                        <span className="font-display font-bold text-xl tracking-tight">PYMASTERS</span>
                    </div>
            ...
            <main className="relative z-10 max-w-7xl mx-auto px-6 py-20 lg:py-32 grid lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-cyan-500/30 bg-cyan-950/30 text-cyan-400 text-xs font-bold tracking-wider uppercase mb-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <button onClick={() => navigate('/login')} className="btn-neo btn-neo-ghost">
                            <Play size={18} className="mr-2 text-cyan-400" fill="currentColor" /> Live Demo
                        </button>
                    </div>
                ...
                <motion.div
                    ...
                    className="relative"
                >
                    <div className="relative z-10 bg-[#0f172a] rounded-2xl border border-white/10 shadow-2xl overflow-hidden aspect-video group transform hover:scale-[1.02] transition-transform duration-500">
                        {/* Fake UI Header */}
                        <div className="h-10 border-b border-white/5 bg-[#020617] flex items-center px-4 gap-2">
                    ...
                    <div className="absolute inset-0 bg-cyan-500/20 blur-[100px] z-0 -translate-y-10"></div>
                </motion.div>
            </main>

            {/* Feature Grid */}
            <section className="relative z-10 py-32 bg-[#020617]/50 border-t border-white/5">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-5xl font-bold mb-4">Neural-Enhanced Learning</h2>
                        <p className="text-slate-400 max-w-2xl mx-auto">The world's first Python learning platform powered by a local Large Language Model.</p>
                    </div>
...
function Feature({ icon, title, desc }) {
    return (
        <div className="group p-8 rounded-2xl bg-[#0f172a] border border-white/5 hover:border-cyan-500/30 transition-all duration-300 hover:bg-[#1e293b]">
            <div className="mb-6 p-4 rounded-xl bg-white/5 w-fit group-hover:scale-110 transition-transform duration-300 border border-white/5">{icon}</div>
